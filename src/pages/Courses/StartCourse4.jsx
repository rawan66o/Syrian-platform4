...
import eclipse02 from "../../assets/images/eclipse02.png";

import styles from "./StartCourse4.module.css";
  ...
  return (
    <div className={styles.startCourse} dir="rtl">
      ...
      <div className={styles.nextPrevieus_container}>
        ...
        <button
          onClick={() => navigate(`${window.location.pathname}/startCourse5`)}
          className={styles.button}

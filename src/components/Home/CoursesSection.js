    ...
    <div className="courses-section">
      <div className="courses-section-content">
        ...
        <div className="courses-section-button">
          <button
            className={type === "languages" ? "active" : ""}
          ...
          <button
            className={type === "management" ? "active" : ""}
          ...
          <button
            className={type === "graphicDesign" ? "active" : ""}
            onClick={() => setType("graphicDesign")}
          >
            غرافيك ديزاين
          </button>

          <button className={type === "arabic" ? "active" : ""} onClick={() => setType("arabic")}>
            العربية
          </button>

          <button
            className={type === "programming" ? "active" : ""}
            onClick={() => setType("programming")}
          >
            البرمجة
          </button>

          <button className={type === "uiux" ? "active" : ""} onClick={() => setType("uiux")}>
            UI/UX
          </button>
        </div>
          ...
          {courses[type]?.map((course, index) => (
            <div className="courses-section-card" key={index}>
              ...
              <div className="button">
                <Link to="/courses" className="card-btn">
                  عرض الكورس
